"""
Django settings for ptu20_postit project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'ptu20.midonow.fi']
...
ROOT_URLCONF = 'ptu20_postit.urls'
...
DATABASES = {
    ...
    'default': {
        ...
        'HOST': 'postgres',
        'NAME': os.getenv('POSTGRES_DB', 'ptu20postit'),
